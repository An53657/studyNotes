...
9. 循环语句
   ...
   - while循环
     ...
     - 循环：重复执行一些操作，while在..期间，while循环就是满足条件期间，重复执行某些代码
     - while循环基本语法
       - ![while循环基本语法](../../imgs/js/基础/Day02/07-循环-while循环-基本语法.png)
       - 释义
         - 跟if语句很象，都要满足小括号里面条件为true才进入循环体执行代码
     ...
     - while三要素
       - 循环的本质是以某个变量为起始值，然后不断产生变化的量，慢慢靠近终止条件的过程
       - 三要素
         ![](../../imgs/js/基础/Day02/08-循环-while循环-三要素.png)
         - 变量的起始值
